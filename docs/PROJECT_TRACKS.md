...
Pushwig contains related but independent work:

1. **Track V — visual/controller product**;
2. **Track A — self-contained appliance packaging**;
3. **Track H — Push internal connector/native-compute research**.

These share contracts but do not form one linear requirement chain.
...
CM11EB/internal-bay research remains optional. External USB through the existing base is first-class and can remain a supported final form.

## Optional integrations

Plug-in bridging, plugdata/Pure Data, Monome, analyzers, and other sources may consume stable Pushwig contracts without becoming prerequisites for the core project.
